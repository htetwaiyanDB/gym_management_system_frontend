...
/* ---------------------------
   Cache (today-only)
--------------------------- */
const STORAGE_KEY = "user_attendance_today_cache_v1";
...
export default function UserScan() {
  ...
  // 2) Load from backend: GET /user/check-in
  useEffect(() => {
    let alive = true;
  ...
  if (!isMobile) {
    return (
      <div className="container py-3" style={{ maxWidth: 520 }}>
        ...
        <div className="alert alert-warning mb-0">Scan works on mobile view only.</div>
      </div>
    );
  }
    ...
    <div className="container py-3" style={{ maxWidth: 520 }}>
      ...
      >
        <div className="d-flex align-items-start justify-content-between">
          <div>
            <div style={{ fontWeight: 800, fontSize: 18 }}>Attendance</div>
